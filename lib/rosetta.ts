 ...
 *
 * A round reads "Everest : Nepal :: Aconcagua : ___". The exemplar pair is
 * what tells the player WHICH relation is meant, so the same right-hand term
 * can head three different questions ("Tokyo : Japan", "Fuji : Japan",
