...
> = {
  ...
  internetAccess: {
    ...
    topic: 'infrastructure',
    glyph: 'infrastructure.internetAccess',
    // Full range: the gap between the least and most connected is the point.
    scale: { min: 0, max: 100 },
    mixed: false,
    race: true,
  },
  electricityAccess: {
    ...
    unit: '%',
    topic: 'infrastructure',
    glyph: 'energy.electricityAccess',
    // Most of the world is at or near 100, so the track starts at 40 to leave
    // the countries where this still climbs somewhere to move.
    scale: { min: 40, max: 100 },
    mixed: false,
    race: true,
  },
  ...
  yearsOfSchooling: {
    ...
    unit: 'years',
    topic: 'education',
    glyph: 'education.averageYearsOfStudy',
    scale: { min: 0, max: 15 },
    mixed: false,
    race: true,
  },
