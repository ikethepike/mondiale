...
// Mulberry32 — the same tiny PRNG the mix tests use. Any seeded generator
// would do; what matters is that it is NOT Math.random, so the wall is a
// property of the round rather than of the moment a client mounted it.
...
const columns = computed(() => {
  const random = seeded(props.seed)
